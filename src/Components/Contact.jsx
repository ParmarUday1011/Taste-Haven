...
import { FaClock, FaEnvelope, FaFacebookF, FaInstagram, FaMapMarkerAlt, FaPhoneAlt, FaTwitter } from "react-icons/fa";
        ...
        <div>
            <section id="contact" className="py-20 bg-[#FFF8E7]">
                <div className="max-w-7xl mx-auto px-6 md:px-20">
                    ...
                    <div className="h-1 bg-orange-500 rounded-full mx-auto mt-4 
    w-20 sm:w-24 md:w-32 lg:w-40"></div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-md p-8">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <a href="#" className="bg-orange-500 text-white p-4 rounded-full hover:scale-110 transition-all">
                                        <FaFacebookF size={20} />
                                    </a>
